        ...
        render: function() {
            return D.div({ className: 'auto-bet-container' },
                D.div({ className: 'stra-base-bet' },
                    D.span({ className: 'bet-title' }, t.T('Base Bet: ')),
                ...
                D.div({ className: 'stra-cash-out-at' },
                    D.span({ className: 'bet-title' }, t.T('Auto Cashout at:')),
                ...
                D.div({ className: 'stra-max-bet-stop' },
                    D.span({ className: 'bet-title' }, t.T('Stop if bet is > ')),
                ...
                D.div({ className: 'stra-on-loss' },
                    D.span({ className: 'bet-title' }, t.T('On loss:')),
                    ReactRadio({ name: 'onLoss', onChange: this.updateOnLoss, defaultValue: this.state.onLossSelectedOpt  },
                        ...
                        D.span(null, t.T('Return to base bet')),
                        D.br(),
                        D.input({
                                type: 'radio',
                        ...
                        D.span(null, t.T('Increase bet by: ')),
                        D.input({
                                type: 'text',
                                ref: 'onLossQty',
                ...
                D.div({ className: 'stra-on-win' },
                    D.span({ className: 'bet-title' }, t.T('On win:')),
