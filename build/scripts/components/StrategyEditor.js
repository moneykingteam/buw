            ...
            return D.div({ id: 'strategy-container' },
                ...
                D.div({ className: 'control-buttons' },
                    ...
                    D.div({ className: 'buttons-container' },
                        D.button({ className: 'strategy-start', onClick: self._runStrategy, disabled: this.state.active || this.state.invalidData || !this.state.engine.username || this.state.engine.connectionState ==! 'JOINED' }, t.T('RUN!')),
                        D.button({ className: 'strategy-stop', onClick: self._stopStrategy, disabled: !this.state.active }, t.T('STOP')),
