                    ...
                    D.table({ className: 'games-log' },
                        D.thead(null,
                            D.tr(null,
                                ...
                                D.th(null, D.div({ className: 'th-inner'}, t.T('Crash'))),
                                D.th(null, D.div({ className: 'th-inner'}, '@')),
                                D.th(null, D.div({ className: 'th-inner'}, t.T('Bet'))),
                                D.th(null, D.div({ className: 'th-inner'}, t.T('Bonus'))),
                                D.th(null, D.div({ className: 'th-inner'}, t.T('Profit'))),
                                D.th(null, D.div({ className: 'th-inner'}, t.T('Hash')))
                            )
                        ),
                        D.tbody(null,
                            rows
