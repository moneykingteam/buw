            ...
            if(notPlayingOrBetting) {
                ...
                if(this.props.isBetting) {
                    ...
                    if (this.props.gameState !== 'STARTING') {
                        btnContent.push(D.span({ key: 'bc-0'}, smallButton? '' : t.T('Betting...')), D.a({ className: 'cancel', key: 'bc-1' }, t.T(' (Cancel)')));
                        onClickFun = this.props.cancelBet;
                        btnClasses += ' cancel';
                    } else {
                        btnContent.push(D.span({ key: 'bc-0'}, t.T('Betting...')));
                    }

                    //Initial disable
                } else if(this.state.initialDisable) {
                	var btnText =   (canUserBet.message === 'Not enough bits')? (smallButton? t.T('Bet') : t.T('Bet too big')) : (smallButton? t.T('Bet') : t.T('Place bet'));
                    ...
                    //Placing bet
                        ...
                        btnContent.push(D.span({ key: 'bc-4' }, smallButton? t.T('Bet') : t.T('Place bet')));
                        btnClasses += ' disable unselect';

                    //Able to bet
                    } else {
                        btnContent.push(D.span({ key: 'bc-5' }, smallButton? t.T('Bet') : t.T('Place bet')));
                        btnClasses += ' ';
            ...
            //The user is playing
                ...
                btnContent.push(
                    D.div({ className: 'btn-content', key: 'bc-6' },
                        D.span({ className: 'cashout-cont' }, t.T('Cash out')),
