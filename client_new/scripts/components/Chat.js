define([
    ...
    var replaceUsernameMentions = function(autolinker, match) {
      ...
      return '<a href="/user/' + username +'" rel="noopener" target="_blank">@' + username + '</a>';
    };
        ...
        render: function() {
            ...
            switch (state.connectionState) {
                ...
                case 'CONNECTING':
                    ...
                    //Input
                    chatInputPlaceholder = t.T('Connecting...');
                ...
                case 'JOINING':
                    ...
                    //Input
                    chatInputPlaceholder = t.T('Joining...');
                    chatInputDisabled = true;
                ...
                case 'JOINED':
                    ...
                    //If user is logged
                    if (state.username) {
                        chatInputPlaceholder = t.T('Type here...');
                        chatInputOnKeyDown = this._sendMessage;

                    //If user is not logged
                    } else {
                        chatInputPlaceholder = t.T('Login to chat...');
                        chatInputDisabled = true;
                    }
                ...
                case 'DISCONNECTED':
                    ...
                    //Input
                    chatInputPlaceholder = t.T('Not connected...');
                    chatInputDisabled = true;
